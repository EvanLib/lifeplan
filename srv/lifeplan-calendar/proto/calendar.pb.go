...
type TasksRequest struct {
	...
	Categorytimestamp    time.Time `protobuf:"bytes,3,opt,name=categorytimestamp,proto3,stdtime" json:"categorytimestamp" bson:"eventtimestamp"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-" bson:"-"`
	XXX_unrecognized     []byte    `json:"-" bson:"-"`
	XXX_sizecache        int32     `json:"-" bson:"-"`
}
...
type TaskList struct {
	Categoryid           string           `protobuf:"bytes,1,opt,name=categoryid,proto3" json:"categoryid,omitempty" bson:"categoryid"`
	Categorytimestamp    time.Time        `protobuf:"bytes,2,opt,name=categorytimestamp,proto3,stdtime" json:"categorytimestamp" bson:"eventtimestamp"`
	TaskStateMap         map[string]int32 `protobuf:"bytes,3,rep,name=TaskStateMap,proto3" json:"TaskStateMap,omitempty" bson:"taskstatemap" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-" bson:"-"`
	XXX_unrecognized     []byte           `json:"-" bson:"-"`
	XXX_sizecache        int32            `json:"-" bson:"-"`
}
...
var fileDescriptor_319e4b398a4282cb = []byte{
	...
	,
}
